...
// Annars:Visa meddelande att boken redan är utlånad.

// returnBook()
// Om isLoaned är true:Sätt isLoaned till false.
// Visa meddelande att boken har returnerats med en smiley.
// Om reservationList inte är tom: Ta bort första användaren från listan.
// Visa att boken nu är reserverad för denna användare.
// Sätt isLoaned till true för att markera att boken är bokad.
// Annars:Visa meddelande att boken inte var utlånad.

// reserve(userName)
// Om isLoaned är true:Lägg till userName i reservationList.
// Visa meddelande att användaren har reserverat boken.
// Annars: Visa meddelande att boken är tillgänglig och kan lånas direkt.
